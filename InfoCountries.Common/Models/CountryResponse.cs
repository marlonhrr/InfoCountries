...
namespace InfoCountries.Common.Models
{
    ...
    public partial class Countries
    {
        public static Countries[] FromJson(string json) => JsonConvert.DeserializeObject<Countries[]>(json, InfoCountries.Common.Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Countries[] self) => JsonConvert.SerializeObject(self, InfoCountries.Common.Models.Converter.Settings);
    }
